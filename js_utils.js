...
(function() {
  var aliasName, aliasing, arrEquals, funcForArgs, getObjectFromPath, method, methodName, parent, preferJSUtils, prototyping, ref, ref1, set, setName,
    slice = [].slice,
  ...
  JSUtils.Tree = (function() {
    ...
    *
    ...
    Tree.prototype.serialize = function(format, doneNodes) {
      var base, base1, child, len1, m, ref2, serializedChildren;
      if (doneNodes == null) {
        doneNodes = [];
      }
      serializedChildren = [];
    ...
    Tree.prototype.getLevelSiblings = function() {
      var ref2, self, siblings;
      self = this;
      siblings = (ref2 = this.getRoot()) != null ? ref2.findNodes(function(node) {
    ...
    *
    ...
    Tree.prototype.inorder = function(callback, level, index, info) {
      ...
      for (i = o = ref3 = index, ref4 = this.children.lenth; ref3 <= ref4 ? o < ref4 : o > ref4; i = ref3 <= ref4 ? ++o : --o) {
        this.children[i].inorder(callback, level + 1, index, info);
        info.idx++;
      }
      return this;
